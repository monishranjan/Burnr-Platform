      ...
      <section className="w-full px-4 py-16">
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center">
          ...
          <p className="text-text-muted text-base sm:text-lg max-w-2xl mb-16 mt-4">
            Burnr is a privacy-first platform offering disposable email addresses to help you stay anonymous and secure online.
          </p>
          ...
          <div className="w-full text-left space-y-12">
            ...
            <div className="space-y-2">
              ...
              <p className="text-text-muted">
                The internet should be a safe place for everyone. Burnr was created to give users a hassle-free way to protect their privacy by using temporary email addresses while signing up on websites, accessing gated content, or avoiding spam.
              </p>
            </div>
